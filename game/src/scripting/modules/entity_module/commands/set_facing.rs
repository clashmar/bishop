...
use crate::scripting::commands::entity::{parse_direction, SetFacingCmd};
...
impl LuaMethod<EntityHandle> for SetFacingMethod {
    fn register<M: UserDataMethods<EntityHandle>>(&self, methods: &mut M) {
        methods.add_method(lua_animation::SET_FACING, |lua, this, direction: String| {
    ...
    fn emit_api(&self, out: &mut LuaApiWriter) {
        ...
        out.line(&format!(
            "function Entity:{}(direction) end",
            lua_animation::SET_FACING
        ));
        out.line("");
    }
}
