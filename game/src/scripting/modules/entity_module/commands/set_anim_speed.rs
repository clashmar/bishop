...
use crate::scripting::commands::entity::SetAnimSpeedCmd;
...
impl LuaMethod<EntityHandle> for SetAnimSpeedMethod {
    fn register<M: UserDataMethods<EntityHandle>>(&self, methods: &mut M) {
        methods.add_method(lua_animation::SET_ANIM_SPEED, |lua, this, speed: f32| {
    ...
    fn emit_api(&self, out: &mut LuaApiWriter) {
        ...
        out.line(&format!(
            "function Entity:{}(speed) end",
            lua_animation::SET_ANIM_SPEED
        ));
        out.line("");
    }
}
