...
entity_handle_methods! {
    ...
    GetKinematicState => GetKinematicStateMethod,
    StartKinematic => StartKinematicMethod,
    StopKinematic => StopKinematicMethod,
    ReverseKinematic => ReverseKinematicMethod,
    SetKinematicEnabled => SetKinematicEnabledMethod,
    SetKinematicMode => SetKinematicModeMethod,
    SetKinematicAxis => SetKinematicAxisMethod,
    SetKinematicDirection => SetKinematicDirectionMethod,
    SetKinematicSpeed => SetKinematicSpeedMethod,
    SetKinematicTravelDistance => SetKinematicTravelDistanceMethod,
    IsKinematicRunning => IsKinematicRunningMethod,
    ...
    CurrentLayer => CurrentLayerMethod,
