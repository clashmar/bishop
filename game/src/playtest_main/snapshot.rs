...
use engine_core::playtest::{
    build_snapshot_payload, payload_value, PlaytestSessionState, PlaytestSnapshot,
...
fn control_profile_frame_budget(profile: &engine_core::agents::AgentControlProfile) -> u64 {
