...
fn sibling_ron_path(path: &Path, suffix: &str) -> PathBuf {
    ...
    let file_name = path
        ...
        .unwrap_or_else(|| "playtest-data.ron".to_string());
...
mod tests {
    ...
    use engine_core::constants::{playtest_artifacts, PLAYTEST_PAYLOAD_RON};
    ...
    fn file_playtest_transport_exposes_request_inbox_path() {
        ...
        assert_eq!(
            ...
            session_dir.join(playtest_artifacts::REQUEST_FILENAME)
        );
    }
    ...
    fn file_playtest_transport_exposes_control_request_path() {
        ...
        assert_eq!(
            ...
            session_dir.join(playtest_artifacts::CONTROL_REQUEST_FILENAME)
        );
    }
    ...
    fn file_playtest_transport_exposes_expanded_control_path() {
        ...
        assert_eq!(
            ...
            session_dir.join(playtest_artifacts::EXPANDED_CONTROL_FILENAME)
        );
    }
}
